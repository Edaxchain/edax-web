...
const Roadmap = () => {
    ...
    const phases = [
        { phase: "Phase 1", title: "MVP Launch", items: ["1", "2", "3"], status: "Done" },
        { phase: "Phase 2", title: "Product Rollout", items: ["Smart City", "Health Care"], status: "In Progress" },
        { phase: "Phase 3", title: "Ecosystem", items: ["Mainnet", "Wallet", "DApps"], status: "Upcoming" },
        { phase: "Phase 4", title: "Global Expansion", items: ["Metaverse Integration", "Carbon Credit Exchange", "DAO Governance"], status: "Upcoming" },
    ];
    const duplicatedPhases = [...phases, ...phases, ...phases];

    return (
        <section id="roadmap" className="py-24 bg-background overflow-hidden border-t border-nav-border">
            <div className="container mx-auto px-6 mb-12 text-center">
                <h2 className="text-4xl md:text-5xl font-black tracking-tighter uppercase mb-4">
                    Project <span className="text-[#14F195] drop-shadow-[0_0_15px_rgba(20,241,149,0.3)]">Roadmap</span>
                </h2>
            </div>
            ...
            <div className="relative flex overflow-hidden py-10">
              ...
              `}>
                                ...
                                <div className="bg-[#0A0A0A] h-full w-full rounded-4xl p-8 md:p-10 flex flex-col relative z-10 overflow-hidden">
                                    ...
                                    {/* Status Tag */}
                                    <div className="mb-6">
                                        <span className={`text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-md border ${item.status === 'Done' ? 'border-emerald-500/50 text-emerald-500 bg-emerald-500/5' :
                                                item.status === 'In Progress' ? 'border-[#14F195] text-[#14F195] bg-[#14F195]/10 animate-pulse' :
                                    ...
                                    {/* Header */}
                                    <div className="mb-6">
                                        <h3 className="text-xl font-bold text-white mb-1 uppercase tracking-tight">{item.phase}</h3>
                                        <h4 className="text-[#14F195] text-xs font-black uppercase tracking-[0.15em] opacity-80">{item.title}</h4>
                                    </div>
