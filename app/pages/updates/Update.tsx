...
const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=800&auto=format&fit=crop";
    ...
    return (
        <>
            ...
            <div className="space-y-6 min-h-[400px]">
                {activeTab === 'news' ? (
                    newsItems.length > 0 ? (
                        newsItems.map((item: any) => renderCard(item, newsSource))
                    ) : (
